            ...
            <div className="">
                ...
                <div className="pt-3">
                    ...
                    <div className="text-sm opacity-60 text-justify">
                        Hii, My name is Ghufran Mahmood . I am a highly skilled
                        and passionate fresher engineer with a strong foundation
                        in programming, software development, system
                        architecture, and electronics. With expertise in backend
                        technologies like Node.js, Express.js, Nest.js |
                        Frontend technologies React.js, PostgreSQL, and Prisma
                        ORM, I specialize in building scalable and efficient
                        applications.
                        ...
                        a strong grasp of modern technologies and a keen eye for
                        optimization, I am eager to contribute to cutting-edge
