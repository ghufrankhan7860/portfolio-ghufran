    ...
    <div className="w-full">
      <div className="w-full">
        ...
        <div className="flex justify-center text-3xl">
          ...
          <div className="">
            <div className="">o</div>
            <div className="text-xs text-cyan-400">2</div>
          </div>
          <div className="">
            <div className="">o</div>
            <div className="text-xs text-cyan-400">3</div>
          </div>
          <div className="">
            <div className="">o</div>
            <div className="text-xs text-cyan-400">4</div>
          </div>
          <div className="">g</div>
          <div className="">l</div>
          <div className="">e</div>
        ...
        <div className="flex justify-around py-5">
          ...
          <div className="text-cyan-400 text-sm">Buisness Solution</div>
          <div className="text-cyan-400 text-sm">Privacy And Terms</div>
